...
function UpdateTripModal({ getTrips, setUpdateModalOpen, updateModalOpen }) {
  ...
  UseEffect(() => {
    const keyHandler = ({ keyCode }) => {
      if (!updateModalOpen || keyCode !== 27) return;
  ...
  // const updatedCities = updatedTrip.cities.split("");
  const handleOnSubmit = (values) => {
    console.log(values);
    axios
      .put(
        `${process.env.REACT_APP_API_URL}/admin/updateTrip/${tripID}`,
        {
          from: values.from,
          to: values.to,
  ...
  return (
    <>
      <>{updatedTrip ? updatedTrip.from : null}</>
      {/* Modal backdrop */}
      <Transition
      ...
      >
        ...
        >
          ...
          <Formik
            initialValues={{
              from: updatedTrip ? updatedTrip.from : "",
              to: updatedTrip ? updatedTrip.to : "",
              deperture_date: updatedTrip ? updatedTrip.deperture_date : "",
              arrival_date: updatedTrip ? updatedTrip.arrival_date : "",
              seats: updatedTrip ? updatedTrip.seats : "",
              price: updatedTrip ? updatedTrip.price : "",
            }}
                  ...
                  <div className="flex flex-col lg:flex-row w-full items-center justify-center gap-6 mt-4">
                    <div className="flex flex-col w-full">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        value={values.deperture_date.split("T")[0]}
                    ...
                    <div className="flex flex-col w-full">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        value={values.arrival_date.split("T")[0]}
                        className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                      />
                      <div className="text-red-500 text-xs italic">
                        {errors.arrival_date &&
